...
Button(root,text="pi",command=lambda :get_operations("3.14")).grid(row=2,column=4)
Button(root,text="%",command=lambda :get_operations("%")).grid(row=3,column=4)
...
Button(root,text="x!",command=lambda :get_operations("x!")).grid(row=2,column=5)
Button(root,text="^2",command=lambda :get_operations("**2")).grid(row=3,column=5)
Button(root,text=")",command=lambda :get_operations(")")).grid(row=4,column=5)
Button(root,text="exp",command=lambda :get_operations("**")).grid(row=5,column=5)
